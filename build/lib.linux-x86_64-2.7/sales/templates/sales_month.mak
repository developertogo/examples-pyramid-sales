...
<head>
    ...
    <meta name="keywords" content="python web application sales month liner graph" />
    <meta name="description" content="pyramid web application - sales month linear graph" />
    <link rel="shortcut icon" href="${request.static_url('sales:static/favicon.ico')}" />
    <link rel="stylesheet" href="${request.static_url('sales:static/css/sales.css')}" type="text/css" media="screen" charset="utf-8" />
